...
parser.add_argument('--overpass_url', default='https://overpass-api.de/api//interpreter', type=str)
parser.add_argument('--nominatim_url', default='https://nominatim.openstreetmap.org/search.php', type=str)
parser.add_argument('--convert_url', default='https://overpass-api.de/api//convert', type=str)
